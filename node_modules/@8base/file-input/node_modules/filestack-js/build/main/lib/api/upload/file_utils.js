...
var mimetype = require("file-type");
 ...
 */
exports.getPart = function (part, _a) {
    var config = _a.config, file = _a.file;
    return new Promise(function (resolve) {
        var length = config.partSize;
        var start = config.partSize * part.number;
        if (file.buffer.byteLength < start + length) {
            length = file.buffer.byteLength - start;
        }
        var filePart = file.buffer.slice(start, start + length);
        var partObj = tslib_1.__assign({}, part, { buffer: filePart, size: filePart.byteLength, md5: md5_1.calcMD5(filePart) });
 ...
 */
exports.getFile = function (inputFile) {
