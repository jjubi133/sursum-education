...
var file_utils_1 = require("./file_utils");
var is_mobile_1 = require("./is_mobile");
var utils_1 = require("./utils");
var intelligent_1 = require("./intelligent");
    ...
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                goChunk = flowControl(ctx, function (chunk) { return intelligent_1.uploadChunk(chunk, ctx); });
                part.chunks = intelligent_1.slicePartIntoChunks(part, part.chunkSize);
                return [4 /*yield*/, Promise.all(part.chunks.map(utils_2.throat(cfg.concurrency, goChunk)))];
            case 1:
                _a.sent();
                return [2 /*return*/, intelligent_1.commitPart(part, ctx)];
            case 2: return [4 /*yield*/, network_1.getS3PartData(part, ctx)];
            case 3:
                s3Data = (_a.sent()).body;
                if (cfg.onProgress) {
                    /* istanbul ignore next */
                    onProgress = utils_2.throttle(function (evt) {
                        /* istanbul ignore next */
                ...
                part.request = network_1.uploadToS3(part.buffer, s3Data, onProgress, cfg);
    ...
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                // Here we go
                state.status = statuses.RUNNING;
                return [4 /*yield*/, cancellable(network_1.start(ctx))];
            case 1:
                params = (_a.sent()).body;
                ctx.params = params;
                goPart = flowControl(ctx, function (partObj) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                    ...
                    return tslib_1.__generator(this, function (_b) {
                        switch (_b.label) {
                            case 0: return [4 /*yield*/, file_utils_1.getPart(partObj, ctx)];
                            case 1:
                                part = _b.sent();
                                if (part.size === 0) {
                ...
                allParts = utils_2.range(0, totalParts).map(function (p) { return makePart(p, ctx); });
                partsFlow = Promise.all(allParts.map(utils_2.throat(config.concurrency, goPart)));
                startProgress(config.onProgress);
                ...
                goComplete = flowControl(ctx, function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                    ...
                    return tslib_1.__generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                _a.trys.push([0, 2, , 3]);
                                return [4 /*yield*/, network_1.complete(etags, ctx)];
                            case 1:
                                res = _a.sent();
                                if (res.status === 202) {
 ...
 * @param token Control token
 */
exports.upload = function (session, fileOrString, options, storeOptions, token, security) {
    if (options === void 0) { options = {}; }
    if (storeOptions === void 0) { storeOptions = {}; }
    if (token === void 0) { token = {}; }
    return file_utils_1.getFile(fileOrString).then(function (file) {
        ...
        var wString = t.String;
        var wStruct = t.struct({
            id: t.String,
        });
        var workflowsUniton = t.union([
            wString,
            wStruct,
        ]);
        ...
        utils_2.checkOptions('upload (options)', allowedOptions, options);
        utils_2.checkOptions('upload (storeOptions)', allowedStoreOptions, storeOptions);
