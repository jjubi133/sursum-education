...
var Client = /** @class */ (function () {
    function Client(apikey, options) {
        ...
        if (options) {
            ...
            if (cname_1) {
                this.session.urls = index_1.resolveHost(this.session.urls, cname_1);
        ...
        this.cloud = new cloud_1.CloudClient(this.session, options);
    }
    /**
    ...
    Client.prototype.upload = function (file, options, storeOptions, token, security) {
        /* istanbul ignore next */
        return upload_1.upload(this.session, file, options, storeOptions, token, security);
    };
    return Client;
}());
