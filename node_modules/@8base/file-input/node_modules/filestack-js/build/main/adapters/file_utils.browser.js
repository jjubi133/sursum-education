...
var md5_1 = require("../lib/api/upload/md5");
/**
 * Is file?
 *
 * @private
...
var b64toBlob = function (b64Data, sliceSize) {
    ...
    var byteCharacters = abab_1.atob(b64Data);
    var byteArrays = [];
 ...
 * @private
 */
exports.getPart = function (part, ctx) {
    return readFile(sliceFile(ctx, part.number))
        .then(function (evt) {
        var buffer = evt.target.result;
        var newPart = tslib_1.__assign({}, part, { buffer: buffer, size: buffer.byteLength, md5: md5_1.calcMD5(buffer) });
        return newPart;
    });
};
/**
 ...
 * @private
 */
exports.getFile = function (fileOrString) {
 ...
 */
exports.closeFile = function () { return undefined; };
