...
describe('storeURL', function storeFunc() {
    ...
    it('should throw an error if no url is set', function () {
        assert.throws(function () { return storeURL(session); });
    });
    it('should handle store without params', function (done) {
        var options = {};
    ...
    it('should replace ":" and "," with "_" in url', function (done) {
        var options = { filename: 'test:t,est.jpg' };
        storeURL(session, ENV.urls.testImageUrl, options)
            .then(function (res) {
            assert.ok(res);
            done();
    ...
    it('should upload file correctly with "/" in path', function (done) {
