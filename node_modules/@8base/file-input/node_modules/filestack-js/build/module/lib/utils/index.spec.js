...
describe('resolveCdnUrl', function () {
    it('should throw exception when using http or src handle and there is no apiKey', function () {
        ...
        assert.throws(function () { return resolveCdnUrl(sessionClone, 'http://test.com'); });
        assert.throws(function () { return resolveCdnUrl(sessionClone, 'src://test.com'); });
    });
});
describe('checkOptions', function () {
    it('should throw exception when wrong option is provided', function () {
        ...
        assert.throws(function () { return checkOptions('retrieveOptions', allowed, options); });
    });
